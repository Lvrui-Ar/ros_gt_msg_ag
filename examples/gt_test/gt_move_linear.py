...
if __name__ == "__main__":
    ...
    # linear_move_right = Controlfunc_gt.GTControl(2,200,-50,0)
    # Controlfunc_gt.move(10,"right",pub,linear_move_right,linear_move_right.x)

    # 测试例子2：测试线速度值为0,角速度值不为0的运动情况
    # linear_test_nospeed = Controlfunc_gt.GTControl(2,0,314,0)
    # n = 10
    # while n>0:
    ...
    linear_test_stop = Controlfunc_gt.GTControl(2,100,200,1)
    n = 10
    while n>0:
